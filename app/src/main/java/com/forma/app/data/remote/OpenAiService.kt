...
class OpenAiService @Inject constructor(
     ...
     * @param reason необязательная причина (боль, нет оборудования, не подходит)
     */
    ...
    suspend fun enrichEngineReview(
        ...
        val userPrompt = buildEnrichmentUserPrompt(session, workout, engineRecommendations, userSex)
